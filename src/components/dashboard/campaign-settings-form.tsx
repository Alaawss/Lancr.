...
export function CampaignSettingsForm({ campaignId, initialSlug, initialSignupCap, isPremium }: CampaignSettingsFormProps) {
  ...
  async function saveSettings(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      await updateCampaignSettings(campaignId, { slug, signupCap: Number(signupCap) });
      router.refresh();
    } catch (caught: unknown) {
      setError(caught instanceof Error ? caught.message : 'Unable to save campaign settings.');
